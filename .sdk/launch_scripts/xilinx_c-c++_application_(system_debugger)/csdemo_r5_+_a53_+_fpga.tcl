...
clear_rpu_reset
targets -set -filter {jtag_cable_name =~ "Digilent JTAG-SMT2NC 210308A1C4B3" && level==0} -index 0
fpga -file H:/workspace_xilinx/tracerSetupExample/TracerSetupUS_wrapper_hw_platform_0/TracerSetupUS_wrapper.bit
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent JTAG-SMT2NC 210308A1C4B3"} -index 1
...
targets -set -nocase -filter {name =~"*R5*0" && jtag_cable_name =~ "Digilent JTAG-SMT2NC 210308A1C4B3"} -index 1
rst -processor
dow H:/workspace_xilinx/tracerSetupExample/csdemo_r5/Debug/csdemo_r5.elf
