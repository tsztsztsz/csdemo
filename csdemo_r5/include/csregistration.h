...
struct cs_devices_t {
    ...
    cs_device_t etm[LIB_MAX_CPU_DEVICES]; /**< Trace source device (ETM/PTM) associated with each core */
    cs_device_t itm;   /**< SWSTIM source on the system (ITM or STM). */
    cs_device_t etf_main;   /**< ETB style trace buffer (ETB/ETF) for the cores and optionally SWSTIM source. */
    ...
    cs_device_t	etf_a53;   /**< ETF (embedded Trace FIFO for A53-ETMs) */
    cs_device_t etr;	/**< ETR (embedded trace Router) */
    cs_device_t	tpiu;   /**< TPIU (Trace Port Interface Unit) */
    cs_device_t fnl_r5;
    cs_device_t fnl_a53;
    cs_device_t fnl_main;
};
