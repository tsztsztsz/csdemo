...
#define CS_TPIU_FLFMT_STATUS    0x300			/**< TPIU status register (FFSR) */
...
#define CS_TPIU_FLFMT_CTRL      0x304			/**< TPIU control register  (FFCR) */
...
#define CS_TPIU_EXTCTL_OUT_PORT 0x404 /**< TPIU  EXTCTL_Out_Port: bit[0]: 1: trace clock from PS Clock Controller, 0: trace Clock from PL */
#define CS_TPIU_EXTCTL_OP_TCLK (1<<0) /** TPIU traceclock option */
#define CS_TPIU_SUP_TEST_PAT_MODE 0x200 /* TPIU Supported Test Pattern Mode*/
...
#define CS_ETB_FLFMT_CTRL_EnTI   0x0002  /**< Continuous Formatting */
...
#define CS_FUNNEL_EnSLV0 (1<<0) /* enable slave port 0 */
#define CS_FUNNEL_EnSLV1 (1<<1) /* enable slave port 1 */
#define CS_FUNNEL_EnSLV2 (1<<2) /* enable slave port 2 */
#define CS_FUNNEL_EnSLV3 (1<<3) /* enable slave port 3 */
